...
<div class="col-sm bg-warning">
	<aside>
		<br>
		<h1>Burgers (Categorie title)</h1>
		<div class = "container">
			<div class="row justify-content-md-center">
				<div class="col col-md-auto">
					<div class="card bg-dark text-light card" id="hamburger" style="width: 18rem;">
						<img src=<?php echo $_SESSION["burger"][0]['image'];?> class="card-img-top zoom" alt="hamburger">
						<div class="card-body">
						  <h5 class="card-title"><?php echo $_SESSION['burger'][0]['nom'];?></h5>
						  <p class="card-text"><?php echo $_SESSION['burger'][0]['description'];?></p>
						</div>
						<div class="card-body">
						  <p><?php echo $_SESSION['burger'][0]["prix"];?>€<span class= "stock">Stock : <span class ="stock-quantity" ><?php $_SESSION["burger"][0]["stock"];?></span></span></p>
						  <p>Quantité:</p>
