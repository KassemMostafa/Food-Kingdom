<nav class="nav navbar-expand-lg navbar-dark bg-dark ">
		<div class="container-fluid">
		  <a class="navbar-brand" href="Index.html"><img id="logo" class=" d.inline-block align-middle" alt="logo" name="logo" src= <?php echo $_SERVER["DOCUMENT_ROOT"]."/img/cuteBurger.png";?> height="40"/>
			Food Kingdom</a>
